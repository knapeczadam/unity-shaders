Shader "Custom/100-109/107_02_Specular_P_Frag" 
{
	Properties
    {
    ...
    SubShader
    {
        Pass 
        {
            ...
            fixed4 frag(vertexOuput i) : SV_TARGET  
            {
                ...
                fixed3 specularColor = SpecularPhong(worldNormalAtPixel, lightDir, worldSpaceViewDir, attenuation, specularMap.rgb, _SpecularPower, _SpecularFactor);
