Shader "Custom/110-119/113_02_Refraction_Frag" 
{
	Properties
    {
        ...
        _RefractionFactor ("Refraction %", Range(0.0, 1.0)) = 1.0
        _RefractiveIndex ("Refractive index", Range(0.18, 4.24)) = 1.0
    ...
    SubShader
    {
        Pass 
        {
            ...
            fixed4 frag(vertexOuput i) : SV_TARGET  
            {
                ...
                float3 reflectionColor = IBLRefl(_Cube, worldRefraction, _Detail, _ReflectionExposure, _RefractionFactor);
