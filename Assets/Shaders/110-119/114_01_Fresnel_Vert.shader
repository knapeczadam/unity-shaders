Shader "Custom/110-119/114_01_Fresnel_Vert" 
{
	Properties
    {
    ...
    SubShader
    {
        Pass 
        {
            ...
            vertexOuput vert(vertexInput v)
            {
                ...
                fixed3 specularColor = SpecularBlinnPhong(o.worldNormal, lightDir, worldSpaceViewDir, attenuation, 1, _SpecularPower, _SpecularFactor);
                ...
                float fresnel = 1.0 -saturate(dot(worldSpaceViewDir, o.worldNormal));
                fresnel = smoothstep(1.0 - _FresnelWidth, 1.0, fresnel);
                
                o.surfaceColor = mainTexCol * diffuseColor + specularColor + ambientColor;
                o.surfaceColor = lerp(o.surfaceColor, o.surfaceColor * reflectionColor, fresnel);
