Shader "Custom/110-119/114_Fresnel_Frag" 
{
	Properties
    {
    ...
    SubShader
    {
        Pass 
        {
            ...
            fixed4 frag(vertexOuput i) : SV_TARGET  
            {
                ...
                float3 specularColor = SpecularBlinnPhong(worldNormalAtPixel, lightDir, worldSpaceViewDir, 1, _SpecularFactor, attenuation, _SpecularPower);
                ...
                finalColor.rgb = lerp(finalColor.rgb, finalColor.rgb * reflectionColor, fresnel);
